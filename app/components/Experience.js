            ...
            <div className="group relative grid pb-1 transition-all sm:grid-cols-8 sm:gap-8 md:gap-4 lg:hover:!opacity-100 lg:group-hover/list:opacity-50">
              ...
              <div className="z-10 sm:col-span-6">
                ...
                <p className="mt-2 text-sm leading-normal">
                  J'ai créé une application mobile qui aide les personnes
                  véhiculées à facilement trouver des techniciens pour la
                  réparation ou entretien de leur véhicules. Les utilisateurs
                  peuvent voir les mécaniciens de la commune où ils se trouvent.
                </p>
                <ul
